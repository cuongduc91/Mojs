            ...
            Handle.prototype._hammerTime = function _hammerTime() {
              var p = this._props,
                ...
                hm = new _hammerjs2.default.Manager(this.el, {
                  recognizers: [
                    [_hammerjs2.default.Pan, {
                      direction: _hammerjs2.default['DIRECTION_' + direction]
                    }]
                  ]
                });
            ...
            */
            ...
            Ripple.prototype._addRipple = function _addRipple() {
              ...
              this.transit = new mojs.Transit((_ref = {
                ...
                fill: 'none',
                stroke: 'hotpink'
              }, _ref['fill'] = 'hotpink', _ref.fillOpacity = .75, _ref.opacity = {
                .85: 0
              }, _ref.radius = 40, _ref.scale = {
                0: 1
              }, _ref.isShowEnd = false, _ref.onStart = function onStart() {
                _this2.isStart = true;
  ...
  function (module, exports, __webpack_require__) {
    ...
    var Modal = function (_Module) {
      ...
      Modal.prototype._render = function _render() {
        ...
        var modalIn = new _modalIn2.default({
          el: this.shakeEl
        });
      ...
      Modal.prototype._createNoiseTween = function _createNoiseTween() {
        ...
        var sideOpts = (_sideOpts = {
          ...
          radiusY: 28,
          radiusX: 76
        }, _sideOpts['angle'] = -90, _sideOpts.scaleY = {
          0: 1
        }, _sideOpts.scaleX = {
          1: 1.1
        }, _sideOpts.duration = 300, _sideOpts.isShowStart = true, _sideOpts.isForce3d = true, _sideOpts);
    ...
    var ModalIn = function (_Module) {
      ...
      ModalIn.prototype._render = function _render() {
        ...
        var circle = new mojs.Shape({
          ...
          radius: 500,
          scale: {
            .1: _pool2.default.getScaler(500)
          },
          isForce3d: true,
          easing: 'cubic.out',
        ...
        var bg = new mojs.Shape({
          ...
          radius: 500,
          scale: {
            0: _pool2.default.getScaler(500)
          },
          duration: BG_DURATION,
          isForce3d: true,
          delay: DELAY + 50
        ...
        var modalTimeline = new mojs.Timeline({
          delay: BG_DURATION + 100
        });
    ...
    var ModalHide = function (_Module) {
      ...
      ModalHide.prototype._render = function _render() {
        ...
        var whiteBigBg = new mojs.Shape((0, _extends3.default)({}, BG_OPTS, {
          ...
          radius: 500,
          scale: {
            .25: _pool2.default.getScaler(500)
          }
        }));
